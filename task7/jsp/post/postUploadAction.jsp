...
<%
    ...
    // //SQL 작성
    String sql ="INSERT INTO post (user_id, title,category_name,content) VALUES (?,?,?,?)"; // 
    
    //sql 전송준비상태로 만들기
    PreparedStatement query = connect.prepareStatement(sql);//전송 준비중인 sql
    query.setString(1,loginId);
    query.setString(2,titleValue);
    query.setString(3,categoryValue);
    query.setString(4,contentValue);
...
<script>
    alert("작성을 완료하였습니다.")
    location.href ="postListUpPage.jsp"
</script>
